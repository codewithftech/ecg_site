const CheckboxRow = ({ label, checked, onChange }) => (
  <button type="button" onClick={onChange} className="flex items-center gap-3 text-left w-full">
    <span
    ...
    <aside id="filter-sidebar" className={wrapClassName}>
      <div className={embedded ? '' : 'sticky top-24'}>
        ...
        <div className="space-y-8">
          <div>
            <h4 className="text-[18px] font-bold leading-6 text-[#0F172A] mb-4">Sub-Categories</h4>
          ...
          <div>
            <h4 className="text-[18px] font-bold leading-6 text-[#0F172A] mb-4">Power Range</h4>
            <div className="space-y-4">
              {powerRanges.map((r) => (
                <CheckboxRow
                  key={r.id}
          ...
          <div>
            ...
            <div className="flex items-center justify-between mt-3">
              <span className="text-[14px] font-medium text-[#0EB7EE]">${priceRange.min}</span>
              <span className="text-[14px] font-medium text-[#F65D2C]">${priceRange.max}</span>
            </div>
          </div>
        </div>
      </div>
