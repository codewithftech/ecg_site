  ...
  return (
    <main id="privacy-policy-main" className="container mx-auto px-6 py-12">
      <div className="flex  lg:flex-row gap-8">
        ...
        <div id="content-area" className="flex-1 bg-card rounded-xl border border-border p-8 lg:p-12">
          <div className="max-w-4xl">
            ...
            <section id="introduction" className="mb-12">
              ...
              <p className="text-secondary leading-relaxed mb-4">
                Welcome to StrictlyEcig (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). We are committed to
                protecting your privacy and ensuring the security of your personal information. This Privacy Policy
                explains how we collect, use, disclose, and safeguard your information when you visit our B2B wholesale
                platform.
              </p>
              <p className="text-secondary leading-relaxed">
                By accessing or using our services, you agree to the terms outlined in this Privacy Policy. If you do
            ...
            <section id="use-of-information" className="mb-12">
              ...
              <div className="bg-muted rounded-lg p-6 mb-4">
                ...
                <p className="text-secondary text-sm">
                  Creating and managing your business account, verifying credentials, and processing applications.
                </p>
              </div>
              <div className="bg-muted rounded-lg p-6 mb-4">
                <h4 className="font-semibold text-foreground mb-2">Order Processing</h4>
                <p className="text-secondary text-sm">
                  Processing orders, managing inventory, handling payments, and arranging shipments.
                </p>
              </div>
              <div className="bg-muted rounded-lg p-6 mb-4">
              ...
              <div className="bg-muted rounded-lg p-6 mb-4">
                ...
                <p className="text-secondary text-sm">
                  Sending promotional materials, product updates, and industry news (with your consent).
                </p>
              </div>
              <div className="bg-muted rounded-lg p-6">
                <h4 className="font-semibold text-foreground mb-2">Compliance &amp; Legal</h4>
                <p className="text-secondary text-sm">
                  Ensuring age verification, regulatory compliance, fraud prevention, and legal obligations.
                </p>
              </div>
            </section>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-secondary">
                      Third-party vendors who assist with payment processing, shipping, analytics, and marketing.
                    </span>
                  </div>
                </li>
                <li className="flex items-start">
            ...
            <section id="age-restriction" className="mb-12">
              ...
              <div className="bg-destructive/10 border border-destructive rounded-lg p-6">
                ...
                <p className="text-secondary leading-relaxed">
                  Our platform is strictly for business-to-business transactions. All account holders must be at least
                  21 years of age (or the legal age in their jurisdiction) and hold valid business licenses. We comply
                  with all applicable tobacco and vaping regulations, including FDA, TPD, and local laws.
                </p>
              </div>
            </section>
            ...
            <section id="changes" className="mb-12">
              ...
              <p className="text-secondary leading-relaxed">
                ...
                &quot;Last Updated&quot; date. We encourage you to review this policy periodically. Continued use of our
